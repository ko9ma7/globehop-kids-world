...
const CORE = [
  ...
  './src/data/countries/index.json', './src/data/world-geometries.json', './src/data/places/index.json',
...
self.addEventListener('fetch', (event) => {
  ...
  const isApi = url.hostname.includes('open-meteo.com') || url.hostname.includes('worldbank.org');
  if (isApi) {
